...
const slides = [
  {
    image: "/1.png",
    caption:
      "รูปคู่เรามีไม่ค่อยเยอะ 📸 พออยู่ด้วยกันแล้วแทบไม่จับโทรศัพท์เลย ส่วนมากเป็นรูปแอบถ่ายซะมากกว่า 😝",
  },
  {
    image: "/2.png",
    caption:
  ...
  },
  {
    image: "/3.jpg",
    caption:
      "ไปอีสสลัคกี้บาร์บีคิวกันน 🍖🔥 วันนั้นเผลอทำตัวงี่เง่าใส่ด้วย เพราะเป็นห่วงเทอกลัวเทอกลับห้องไม่ทัน ขอโทษค้าบ 🙏",
  },
  {
    image: "/4.jpg",
    caption:
      "เฝ้าไอ้เด็ก 🐶 วันนั้นเราไม่เข้าใจกัน 😔 เค้าก็ยังทำได้แค่อยู่ข้างๆแบบเงียบๆ 🤍 ตอนนั้นเหมือนโดนตบหน้าเรียกสติเลย",
  },
  {
    image: "/5.png",
    caption:
      "ไปเที่ยวอควาเรี่ยม 🐠 กินเค๊กกันด้วยชิ้นนึง 🍰 ก่อนเข้าที่พัก 🏠 ตกเย็นก็ไปริมหาด เป็นครั้งแรกที่เค้ากินไก่แมค",
  },
  {
    image: "/6.png",
  ...
  {
    image: "/7.png",
    caption: "เดี๋ยวนะ 🤔 ตรงนี้เราลงมาทำไม มันไม่ใช่ทางออกนี่ 55555555 😂",
  },
  {
    image: "/8.png",
    caption:
      "ให้ใส่บ่อยมว๊าาก 🧥 กลัวเทอร้อนนี่นา ☀️ ตอนนี้ยกให้ไปแล้ว อย่างน้อยก็เป็นอ้อมกอดในวันที่เราต้องไกลกัน",
  },
  {
    image: "/9.png",
    caption: "ปิดท้ายด้วยชาบูอีกแย้ววววว ขุนกันจนอ้วง 🍲💞",
  },
];
  ...
  useEffect(() => {
    ...
    switch (scene) {
      ...
      case "showAnniversary":
        // timeout = setTimeout(() => setScene("reviewJourney"), 7000);
        break;
      ...
      <AnimatePresence mode="wait">
                ...
                <button
                  onClick={() => {
                    ...
                    if (audio && audio.paused) {
                      fadeIn(audio, 3000); // เล่นเพลงหลัง interaction
                    }
                    setScene("reviewJourney");
                  }}
                  style={{
                    backgroundColor: "#FFCAC9",
                    color: "#9F5857",
                  ...
                  className="mt-6 px-4 py-2  rounded-lg shadow  transition-all duration-200 font-bold"
                >
                  กดเพื่อเริ่มเล่น
                </button>
              </div>
        ...
        {scene === "tellJoke" && (
          <motion.div
            ...
            className="flex flex-col items-center justify-center min-h-screen px-8 text-center"
          >
            <p className="text-2xl text-gray-800">วันนี้คือ วันพุธ แฮร่ !</p>
            <button
              onClick={handleBack}
              className="flex items-center gap-5 mt-6 px-4 py-2 rounded-lg border-2 border-pink-400 shadow-[2px_2px_0px_#000] hover:shadow-[4px_4px_0px_#000] transition-all duration-200 font-bold"
              style={{
        ...
        {scene === "reviewJourney" && (
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-md">
              ...
              <br />
              ผ่านเรื่องราวทั้งดีและร้ายมากมาย เข้าใจกันบ้าง ไม่เข้าใจกันบ้าง
              <br />
              แต่ก็ยังมีกันอยู่ตรงนี้
              <br />
              ขอบคุณนะคะ 💑
            </p>
            <button
          ...
          <div className="flex flex-col justify-center items-center">
            <motion.p className="text-3xl italic text-pink-600 max-w-md leading-relaxed text-center">
              {[
                ...
                "เค้าไม่น้อยใจเลย มีความสุขมากกว่าอีก ที่หันมาเคารพพื้นที่ของกันและกัน",
        ...
        {scene === "lastThanks" && (
          ...
          >
            <p className="text-2xl font-bold text-pink-600">
              สุดท้ายแล้ว... สุขสันต์วันครบรอบนะคับไอ้เด็ก 💖
            </p>
            <p className="mt-4 text-lg text-gray-700">
              เราอาจไม่ได้อยู่ด้วยกันตลอดเวลา
              แต่สิ่งที่สำคัญคือการเข้าใจกันและกัน ถึงเค้าอาจพลาดบ้างในบางครั้ง
              แต่ตอนนี้เค้ากำลังพยายามพัฒนาตัวเอง
              เพื่อให้เราทั้งคู่ก้าวไปข้างหน้าด้วยกันอย่างมั่นคง
              ขอบคุณที่อยู่อ่านจนจบ... Love U Kub ❤️
              <br />
              CODE : 143
            </p>
            ...
            >
              ...
              <span>เริ่มเล่นใหม่อีกครั้ง</span>
            </button>
          </motion.div>
        )}
      </AnimatePresence>{" "}
